...
import EstudiosPage from '../pages/principal/EstudiosPage'
...
import RegistrarUsoInsumoPage from '../pages/estudios/RegistrarUsoInsumoPage'
    ...
    <Router>
      <Routes>
        ...
        >
          ...
          <Route path='/registrar-uso-insumo' element={<RegistrarUsoInsumoPage />} />
        </Route>
      </Routes>
    </Router>
  )
